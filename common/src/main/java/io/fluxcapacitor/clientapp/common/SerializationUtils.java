...
public class SerializationUtils {
    ...
    @SneakyThrows
    public static <T> T deserialize(String fileName, JavaType type) {
        return jsonMapper.readValue(FileUtils.loadFile(fileName), type);
    }
    ...
    @SneakyThrows
    public static String asString(Object object, Class<?> view) {
        return jsonMapper.writerWithView(view).writeValueAsString(object);
    }
}
